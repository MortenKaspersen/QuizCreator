namespace QuizCreator.Migrations
{
    ...
    public partial class InitialMigrationAddingQuestionTagOwnerUserToDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ExplanationText = c.String(),
                        CreatedAt = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.OwnerUsers", t => t.OwnerUserId, cascadeDelete: true)
